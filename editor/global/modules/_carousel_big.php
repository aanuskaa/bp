	<?php 
		if(!isset ($carousel_background_src))
			$carousel_background_src = "/global/content/carousel-big_background.jpg";
	?>	


	<div id="carousel">
		<div id="carousel-background">
			<img src="<?php echo $carousel_background_src ?>" id="carousel-image">
		</div>
				...
				<div class="row  carousel-content">
										...
										<div class="content">
											...
											<div class="menu">
												<div class="left-column column">
													<div class="header">Podľa výberu alebo čo</div>
													<div class="links">
														<div class="link"> <i class="icon icon-right164"></i>
															<a class="text">Všetky procesy</a>
														</div>
														<div class="link">
															<i class="icon icon-right164"></i>
															<a class="text">Procesy s najviac case-mi</a>
														</div>
														<div class="link">
															<i class="icon icon-right164"></i>
															<a class="text">Najpoužívanejsie procesy</a>
														</div>
													</div>
												</div>
											...
											<div class="menu">
												<div class="left-column column">
													...
													<div class="links">
														<div class="link">
															<i class="icon icon-right164"></i>
															<a class="text">Všetky firmy</a>
														</div>
														<div class="link">
															<i class="icon icon-right164"></i>
															<a class="text">Firmy s najviac case-mi</a>
														</div>
														<div class="link">
															<i class="icon icon-right164"></i>
															<a class="text">Najpoužívanejsie firmy</a>
														</div>
													</div>
												</div>
												<div class="right-column column">
					...
					<div class="col-lg-4">
						<div class="quickregistration">
							<div class="header">Pridajte sa k nám</div>
							<input class="name" placeholder="Meno" type="text">
							<input class="surname" placeholder="Priezvisko" type="text">
							<input class="email" placeholder="Email" type="text">
							<input class="password" placeholder="Heslo" type="text">
							<div class="footer">
								<button class="register">
									<i class="icon icon-locked61"></i>
									<a href="/">Okamžitá registrácia</a>
								</button>
							</div>
						</div>
					</div>
